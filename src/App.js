...
import {Followers} from "./App/Layouts/Followers";
...
import {CreateCard} from "./App/Layouts/CreateCard";
import {MyCreditCardInfo} from "./App/Layouts/Profile/MyCreditCardInfo";
import {Translate} from "./App/Layouts/Translate";
...
function App() {
    return (
        <div className='m-4 d-flex' style={{
